...
public class TopMusicianRankingFragment extends Fragment {
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_ranking_musician, container, false);
    ...
    private void initComponents(View v) {
        ListView musicianRankingListView = (ListView) v.findViewById(R.id.musicianRankingListView);

        //TODO Ler do servidor
        List<Profile> profileItemList = setPartialProfiles();

        final TopMusicianRankingListAdapter adapter = new TopMusicianRankingListAdapter(getActivity(), R.layout.ranking_musician_item, profileItemList);
        musicianRankingListView.setAdapter(adapter);
    }

...
public class PlaylistItemListAdapter extends ArrayAdapter<CifraItem> {
    private List<CifraItem> mCifraItemList;
    private Activity mActivity;

    public PlaylistItemListAdapter(Activity activity, int textViewResourceId, List<CifraItem> cifraItemList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = LayoutInflater.from(mActivity).inflate(R.layout.playlist_cifra_item, null);
        }
